...
const EMPTY = { company: '', contact_name: '', email: '', phone: '', pricing_tier_id: '', rep_name: '', rep_phone: '', is_active: true }
      ...
      <div className="overflow-hidden rounded-xl border border-slate-200 bg-white">
        <table className="w-full text-sm">
          <thead><tr className="border-b border-slate-200 bg-slate-50 text-left text-xs uppercase text-slate-500">
            ...
            <th className="px-4 py-2.5 font-semibold">等級</th><th className="px-4 py-2.5 font-semibold">登入</th><th className="px-4 py-2.5 font-semibold">狀態</th><th className="px-4 py-2.5"></th>
          </tr></thead>
          <tbody>
            {dealers.map(d => (
            ...
            {dealers.length === 0 && <tr><td colSpan={6} className="px-4 py-10 text-center text-sm text-slate-400">尚無經銷商，點右上角新增</td></tr>}
          </tbody>
        </table>
      </div>
    </div>
